...
import userSix from '../images/BackOffice//user/user-06.png';
...
return (
  userData ? (
    <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="profile-content p-4 md:p-6">
        <div className="profile-info flex items-center">
          <div className="profile-picture mr-4">
            <img src={userData.image} alt="Profile" className="rounded-full w-16 h-16 md:w-20 md:h-20" />
          </div>
          <div className="profile-details">
            <h2 className="text-lg md:text-xl font-bold">User Profile</h2>
            <p className="text-sm md:text-base"> {userData.firstName}</p>
            <p className="text-sm md:text-base"> {userData.lastName}</p>
            <p className="text-sm md:text-base"> {userData.email}</p>
          </div>
        </div>
        <div className="profile-actions mt-4 md:mt-6">
          <Link
            to="/edit-profile"
