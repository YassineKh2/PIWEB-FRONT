                        ...
                        <div className="w-full px-4 flex justify-center flex-col md:flex-row gap-10">
                            ...
                            <ol className=" space-y-4  md:mt-30 ">
                                {steps.map((step) => {
                                    ...
                                    return (
                                        <li key={step.id} onClick={() => setstep(step.stage)}
                                            ...
                                            <div
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    {step.stage === currentStep && (
                                                        <svg className="ml-2 rtl:rotate-180 w-4 h-4" aria-hidden="true"
                            ...
                            <div
                                ...
                                {currentStep !== 0 &&
                                    <Back size={25} className="text-blue-800 mb-10" onClick={prev}></Back>}
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    {currentStep === 0 && (
                                        ...
                                        >
                                            ...
                                            <div className="mb-8">
                                                ...
                                                />
                                                {errors.firstName &&
                                                    <p className="text-danger my-2">{errors.firstName.message}</p>}
                                            ...
                                            <div className="mb-8">
                                                ...
                                                />
                                                {errors.lastName &&
                                                    <p className="text-danger my-2">{errors.lastName.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                    htmlFor="email"
                                            ...
                                            <div className="mb-8">
                                                ...
                                                {errors.confirmPassword &&
                                                    <p className="text-danger my-2">{errors.confirmPassword.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                    htmlFor="birthDate"
                                                ...
                                                {errors.birthDate &&
                                                    <p className="text-danger my-2">{errors.birthDate.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                    htmlFor="cin"
                                    ...
                                    {currentStep === 1 && (
                                        ...
                                        >
                                            ...
                                            <div className="mb-8">
                                                ...
                                                {errors.position &&
                                                    <p className="text-danger my-2">{errors.position.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                    htmlFor="bio"
                                                ...
                                                <textarea
                                                    {...register("bio")}
                                                    name="bio"
                                                    placeholder="Introduce yourself to the world in a few words"
                                                    className="w-full rounded-md border border-transparent py-3 px-6 text-base text-body-color placeholder-body-color shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-[#242B51] dark:shadow-signUp"
                                                ></textarea>

                                                {errors.bio &&
                                                    <p className="text-danger my-2">{errors.bio.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                ...
                                                {errors.socialMediaHandle &&
                                                    <p className="text-danger my-2">{errors.socialMediaHandle.message}</p>}
                                            </div>
                                            <div className="mb-8">
                                                <label
                                                    htmlFor="image"
                                                ...
                                                <div
                                                    ...
                                                    {errors.image &&
                                                        <p className="text-danger my-2">{errors.image.message}</p>}
                                                </div>
                                    ...
                                    {currentStep === 2 && (
                                        ...
                                        >
                                            ...
                                            <label className="inline-flex items-center cursor-pointer">
                                                <input type="checkbox" defaultChecked={true} value=""
                                                ...
                                                <span
                                                    className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Allow Team Invitations</span>
                                            </label>
                                            <label className="inline-flex items-center cursor-pointer">
                                                ...
                                                <div
                                                    className="relative w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                                <span
                                                    className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Allow </span>
                                            </label>
                                            <label className="inline-flex items-center cursor-pointer">
                                                <input type="checkbox" value="" className="sr-only peer"/>
                                                <div
                                                    className="relative w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                                <span
                                                    className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Large toggle</span>
                                            </label>
                                            <hr/>
                                            <p className=" text-base font-semibold text-body-color">
                                                Mail And Updates
                                            ...
                                            <label className="inline-flex items-center cursor-pointer">
                                                ...
                                                <div
                                                    className="relative w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                                <span
                                                    className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Receive Updates And News</span>
                                            </label>
                                    ...
                                    {errors.root && (
                                        <div id="toast-bottom-left"
                                             className="fixed bg-red-500 text-white flex items-center w-full max-w-xs p-4 space-x-4 divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow bottom-5 right-5 dark:text-gray-100 dark:divide-gray-700 space-x dark:bg-red-800"
                                             role="alert">
