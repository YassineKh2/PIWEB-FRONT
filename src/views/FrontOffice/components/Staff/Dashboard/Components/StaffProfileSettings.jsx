...
import {getUserData, updateStaffImage, updateUser} from "../../../../../../Services/apiUser.js";
...
export default function StaffCredentials() {
    ...
    useEffect(() => {
        try {
            ...
            getUserData(decodedToken.userId).then((response) => {
                ...
                setimage(pathStaff + response.user.image)
    ...
    function handleImageChange(e) {
        ...
        updateStaffImage(updatedStaff).then(() => {
            setToast(true)
        ...
        <>
            <div
                ...
                <div className="flex gap-10 justify-between">
                    <div >
                                <p className="py-2 text-xl font-semibold">{staff.firstName} {staff.lastName}</p>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        {staffPositionMapping[staff.position]}
                    </p>
