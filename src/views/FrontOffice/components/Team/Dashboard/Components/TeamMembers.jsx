...
export default function TeamMembers() {
    ...
    return (
        <>
            <div className="dark:bg-neutral-700 dark:text-gray-100  col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                <div className="pt-4">
                            ...
                            return (
                                <Fragment key={index}>
                                    {ShowPlayersDetails[index].show ? (
                                        <>
                                            <div className="rounded-md  border bg-white dark:bg-neutral-700 dark:text-gray-100 ">
                    ...
                    >
                        <div
                            ...
                            <div
                                ...
                                }} className="whitespace-nowrap rounded-md dark:bg-gray-800 bg-gray-200 px-4 py-3 font-medium">Cancel, Kick
                                    from the team
                                </button>
                            </div>
                        </div>
...

            {
                AddPlayer && (
                    ...
                    >
                        <div className="relative dark:bg-neutral-700 dark:text-gray-100 bg-white m-10 max-w-lg rounded-md border text-gray-800 shadow-lg">
