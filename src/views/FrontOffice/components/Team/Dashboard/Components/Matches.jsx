...
import {getMatchesByTeam, getTeamDetails} from "../../../../../../Services/FrontOffice/apiTeam.js";
...
export default function Matches() {
    ...
    useEffect(() => {
        getMatchesByTeam("65d1f6221f1c5de5ae1bffc5").then((response) => {
                                ...
                                <li>
                                    <div
                                        ...
                                        <label htmlFor="filter-radio-example-1"
                                               className="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Last
                                            day</label>
                                    </div>
                                </li>
                                <li>
