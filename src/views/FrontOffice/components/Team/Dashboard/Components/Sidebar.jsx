...
import { MdCallReceived as Receive} from "react-icons/md";



export default function Sidebar() {
    const [ShowAccountSettings, setShowAccountSettings] = useState(false)
    const [ShowInvitions, setShowInvitions] = useState(false)
                ...
                <aside id="cta-button-sidebar"
                    ...
                    <div className="h-full rounded-3xl px-3 py-4 overflow-y-auto bg-gray-100 dark:bg-neutral-900">
                        <ul className="space-y-2 font-medium">
                            ...
                            <li>
                                <a onClick={() => setShowInvitions(!ShowInvitions)}
                                      className="flex hover:cursor-pointer items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    <svg
                                ...
                                {ShowInvitions && (
                                    <>
                                        <ul className="ml-4">
                                            ...
                                            <li>
                                                <Link to="sentinvitations"
                                                      className="hover:text-gray-900 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                    <Mail size={20}
                                                                 className="text-gray-500 hover:text-gray-900"/>
                                                    <span className="flex-1 ms-3 whitespace-nowrap">Sent Invitations</span>
                                                </Link>
                                            </li>
                                        </ul>
                                    </>
