...
import {
  ...
  GetCountries,
  GetStateByCountry,
} from "../../../../../Services/APis/CountryAPI.js";
              ...
              "
                  >
                    ...
                    >
                      ...
                      {currentStep === 1 &&
                        "Enter your team's description details here."}
                      {currentStep === 2 &&
                        "Add your players and coaches here."}
                      {currentStep === 3 &&
                        "Add your sponsors and other details here."}
                    </p>
...
{showForm && (
              ...
              >
                <div className="container">
                  ...
                  <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                      <OfferList
                        text="Access To All Tournaments"
                        status="active"
                      />
                      <OfferList
                        text="Limited Team Management"
                        status="active"
                      />
                      <OfferList
                        text="Basic Match Scheduling"
                        status="active"
                      />
                      <OfferList
                        text="Access to Basic Football Stats"
                        status="active"
                      />
                    ...
                    >
                      ...
                      <OfferList text="Ad-Free Experience" status="active" />
                      <OfferList
                        text="Historical Data And Match Replays"
                        status="active"
                      />
                      <OfferList
          ...
          {errors.root && (
            <div className="flex mb-4">{errors.root.message}</div>
          )}
        </form>
      </section>
