...
export default function UpdateTeam(team) {
    const {
        register,
        handleSubmit,
        ...
        defaultValues: {
            name: team.name,
            nameAbbreviation: team.nameAbbreviation,
            ...
            <div className="flex justify-center items-center h-screen mt-16">
                <div className="w-full px-4 lg:w-8/12 xl:w-6/12">
                    ...
                    >
                        ...
                        <form role="form" encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
